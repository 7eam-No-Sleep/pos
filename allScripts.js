...
function displayInventory(inventoryData) {
    ...
    inventoryData.forEach(product => {
        ...
        productElement.innerHTML = `
            ...
            <button class="print-barcode-button" data-product-id="${product.ProductID}" data-description="${product.Description}">Print Barcode</button>
            <hr>
        `;
...
function displayProducts(products) {
    ...
    products.forEach(product => {
        ...
        row.innerHTML = `
            ...
            <td><button class="print-barcode-button" data-product-id="${product.ProductID}" data-description="${product.Description}">Print Barcode</button></td>
        `;
...
function setupPrintBarcodeButton() {
    document.querySelectorAll('.print-barcode-button').forEach(button => {
        button.addEventListener('click', () => {
            ...
            // Retrieve item description from the button's data-description attribute
            ...
            window.location.href = `print_barcode.html?productId=${productId}&description=${itemDescription}`;
